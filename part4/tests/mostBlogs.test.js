...
describe('most blogs', () => {
  ...
  test('list with 0 blogs returns an object with no author and 0 blogs', () => {
    const result = mostBlogs(listWith0Blogs)
...
describe('most blogs', () => {
  ...
  test('list with 1 blog returns its own author and 1 blog', () => {
...
describe('most blogs', () => {
  ...
  test('list with multiple blogs', () => {
    const result = mostBlogs(listBlog)
